...
const languageFilterObj = {
  ...
  appendSelector: function (where) {
    this.selector.classList.add("language-selector"); // add class name
...
const regionFilterObj = {
  ...
  appendSelector: function (where) {
    this.selector.classList.add("region-selector"); // add class name
    where.appendChild(this.selector);
  },
...
const brancheFilterObj = {
  ...
  appendSelector: function (where) {
    this.selector.classList.add("branch-selector"); // add class name
    where.appendChild(this.selector);
  },
...
const generateJob = (param) => {
  ...
  vorspann.className = "description";
